...
# Main function
def main(dataset_name, split, batch_size=32, save_path="llava-results.json", device="cuda"):
    # Load dataset
...
if __name__ == "__main__":
    ...
    main(args.dataset_name, args.split, args.batch_size, args.save_path, device)
