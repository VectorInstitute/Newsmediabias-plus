...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Judge Llama Vision Inference Results")
    parser.add_argument("--model_name", type=str, default=MODEL_NAME, help="Name of the model to use for inference.")
    parser.add_argument("--dataset_csv", type=str, default='llama-vision-ift-inference_results.csv', help="Path to the dataset CSV file.")
    parser.add_argument("--image_folder", type=str, default='dataset-phi/sampled_images', help="Path to the folder containing images.")
    parser.add_argument("--output_csv", type=str, default='judge-llama-ift-vision-results.csv', help="Path to save the output CSV file.")
