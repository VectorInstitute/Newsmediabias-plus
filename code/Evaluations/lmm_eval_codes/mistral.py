...
class MistralClassifier:
    def __init__(self, model_name="mistralai/Mistral-7B-Instruct-v0.3", max_length=1500):
...
if __name__ == "__main__":
    # Argument parser
    parser = argparse.ArgumentParser(description="Mistral Classifier for Disinformation Detection")
    parser.add_argument("--input_path", type=str, default="dataset.csv",
                        help="Path to the input dataset CSV file.")
    parser.add_argument("--output_path", type=str, default="mistral.csv",
                        help="Path to save the output CSV file.")
    parser.add_argument("--checkpoint_path", type=str, default="checkpoint.txt",
