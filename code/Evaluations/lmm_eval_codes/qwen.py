...
def evaluate(model, dataloader, processor, device, 
             temp_save_path="Qwen2VL_temp.json"):
    model.eval()
    results = []
...
def main(dataset_name, split, 
         batch_size=32, save_path="qwen_results.json", 
         temp_save_path="Qwen2VL_temp.json", 
         device="cuda"):
    # Load existing results
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", type=str, default="maximuspowers/nmb-plus-cleaned", help="Dataset name")
