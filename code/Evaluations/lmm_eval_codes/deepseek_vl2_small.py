...
RESULTS_FILE = "results_deepseek.json"  # File to save results
...
def process_sample(sample_id, dataset_sample, processor, model, tokenizer):
...
if __name__ == "__main__":
    ...
    # Load model and processor
    hf_model_path = "deepseek-ai/deepseek-vl2-small"
    ...
    for sample in tqdm(dataset):
        ...
        # Process the sample
        result = process_sample(sample_id, sample, processor, model, tokenizer)
