...
def annotate_image(image_path, context):
    """
    Annotate an image using the Pixtral model, analyzing its content and potential bias.
    """
...
def process_image(image_info):
    """
    Process a single image, annotate it, and return the results.
    """
...
def process_images_in_folder(folder_path, csv_data, output_path):
    """
    Process all images in the specified folder, annotating each one and writing results to a CSV file.
    """
    images = [
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Annotate images using Pixtral model.")
    parser.add_argument('--data_dir', type=str, default="/projects/NMB-Plus/consolidated_data", help="Directory containing images and CSV data.")
    parser.add_argument('--output_path', type=str, default="PIXTRAL_image_annotations.csv", help="Path to save the output CSV file.")
