...
class BertClassifier:
    def __init__(self, model_name="google-bert/bert-large-uncased", 
    ...
    def eval(self, dataset, batch_size=100):
        ...
        class_metrics = class_metrics.drop(['accuracy', 
                                            'macro avg', 
                                            'weighted avg'])
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="BERT Large Classifier for Text Classification")
