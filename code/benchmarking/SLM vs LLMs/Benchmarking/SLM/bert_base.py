...
class BertClassifier:
    """Bert Classifier for Sequence Classification"""
    def __init__(self, 
                 model_name="google-bert/bert-base-uncased", 
                 num_labels=2, max_length=500, dropout_rate=0.2,cache_dir='./cache'):
...
if __name__ == "__main__":
    ...
    classifier = BertClassifier(num_labels=2, max_length=512, dropout_rate=0.3, cache_dir=args.cache_dir)
