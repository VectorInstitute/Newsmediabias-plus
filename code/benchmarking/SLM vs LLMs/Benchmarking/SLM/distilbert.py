...
class BertClassifier:
    ...
    def eval(self, dataset, batch_size=100):
        ...
        test_dataloader = DataLoader(dataset, sampler=SequentialSampler(dataset), 
                                     batch_size=batch_size)
        self.model.eval()
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="DISTILBERT Classifier for Text Classification")
