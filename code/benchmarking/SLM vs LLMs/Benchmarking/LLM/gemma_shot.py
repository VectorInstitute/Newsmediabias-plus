...
class GemmaClassifier:
    def __init__(self, cache_dir, model_name="google/gemma-2-9b-it", 
    ...
    def eval(self, text, true_vals):
        ...
        report = classification_report(targets, preds, target_names=['Likely', 'Unlikely'], 
                                       output_dict=True)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Gemma Classifier")
    parser.add_argument("--cache_dir", type=str, 
                        default="./cache", help="Directory to cache model files")
    parser.add_argument("--test_file", type=str, 
                        default="Benchmarking/sample_test.csv", 
                        help="Path to the test CSV file")
    parser.add_argument("--shot_type", type=str, 
                        default="0-shot", 
                        choices=["0-shot", "2-shot"], 
    ...
    classifier = GemmaClassifier(cache_dir=args.cache_dir, 
                                 max_length=1024, 
