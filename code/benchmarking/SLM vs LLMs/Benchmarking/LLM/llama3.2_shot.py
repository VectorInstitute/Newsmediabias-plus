...
model_name = "llama_classifier"

tracker = EmissionsTracker(project_name=f"{model_name}", output_dir=f"./{model_name}", output_file=f"{model_name}_emissions.csv")


class LlamaClassifier:
    def __init__(self, model_name="meta-llama/Llama-3.2-3B-Instruct", max_length=500, shot_type="0-shot"):
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Llama Classifier")
    ...
    parser.add_argument("--shot_type", type=str, default="0-shot", 
                        choices=["0-shot", "2-shot"], help="Choose between 0-shot and 2-shot")
    ...
    classifier = LlamaClassifier(cache_dir=args.cache_dir, 
                                 max_length=1024, 
