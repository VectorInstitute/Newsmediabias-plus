...
class LlamaClassifier:
    def __init__(self, cache_dir, model_name="meta-llama/Llama-3.2-1B-Instruct", num_labels=2, max_length=500):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cache_dir", type=str, 
                        default="./cache", help="Directory to cache model and tokenizer")
    parser.add_argument("--train_file", type=str, 
                        default="Benchmarking/sample_train.csv", help="Path to the training data CSV file")
    parser.add_argument("--test_file", type=str, 
                        default="Benchmarking/sample_test.csv", help="Path to the test data CSV file")
    ...
    classifier = LlamaClassifier(num_labels=2, max_length=1024,cache_dir=args.cache_dir)
